...
\vskip -1in
\heol\psfig{file=ivoa.ps,width=5.0in}
...
\color{dblue}
\vskip 0.2in
\par\noindent \htmtitle{IVOA Spectral Data Model}{Version 1.01}
\Large
\vskip 0.1in
\par\noindent{\bf IVOA Proposed Recommendation 2007-05-15}
\color{Black}
\vskip 0.2in

\normalsize

\par\noindent{\bf This version (Release Candidate 2 Rev 15 )}


{\color{dblue}
\htmladdnormallink{http://www.ivoa.net/Documents/WD/DM/SpectrumDM-20070515.html}
...
{\color{dblue}
\link{http://www.ivoa.net/Documents/WD/DM/SpectrumDM-20061024.pdf}
}
...
Kelly McCusker, Pavlos Protopapas, Arnold Rots, Randy Thompson, Frank Valdes,
...
spectral data and serializations in VOTABLE, FITS, and XML, for use as a
standard method of spectral data interchange.
