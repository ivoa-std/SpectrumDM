...
\color{dblue}
\vskip 0.2in
\par\noindent \htmtitle{IVOA Spectral Data Model}{Version {\new 1.2}}
\Large
\vskip 0.1in
\par\noindent{\bf IVOA Working Draft 20101225}
\color{Black}
\vskip 0.2in

\normalsize

\par\noindent{\bf This version (Mod 1)}

{ 
\color{dblue}
\htmladdnormallink{http://www.ivoa.net/Documents/REC/DM/SpectrumDM-20101225.pdf}{}
...
Jonathan McDowell, Doug Tody,  Pedro Osuna, Jesus Saldago, Carlos Rodrigo Blanco,
Enrique Solano, Joe Mazzarella, Raffaele D'Abrusco, Mireille Louys,
Tamas Budavari,  Markus Dolensky, Inga Kamp, 
Kelly McCusker, Pavlos Protopapas, Arnold Rots, Randy Thompson, Frank Valdes, Petr Skoda, Bruno Rino, Jim Cant
...
spectra, time series data, photometry data points,
...
NSF and NASA under the Virtual Astronomical Observatory (VAO) project,
...
Spectra {\new and photometric data} are stored in many different ways within the astronomical
community. In this document we present a proposed abstraction for
such data, which can be used for describing spectrum {\new and photometry} datasets and
...
\colorbox{iblue}{
\psfig{file=specumln7.eps,width=6.0in}
}
...
\psfig{file=pco.eps,width=6.0in}
}
{
\colorbox{iblue}{
\begin{minipage}{6.0in}
...
\colorbox{iblue}{
\psfig{file=corr.eps,width=5.0in}
}
