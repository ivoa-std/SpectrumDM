...
\vskip -1in
\heol
\psfig{file=diagrams/ivoa.ps,width=5.0in}
...
\color{dblue}
\vskip 0.2in
\par\noindent \htmtitle{IVOA Spectrum Data Model}{Version 1.1}
\Large
\vskip 0.1in
\par\noindent{\bf IVOA Proposed Recommendation 20111020}
\color{Black}
\vskip 0.2in

\normalsize

\par\noindent{\bf This version (Mod 8)}

{ 
\color{dblue}
%\htmladdnormallink{http://www.ivoa.net/Documents/REC/DM/SpectrumDM-20111020.pdf}{}
PR-SpectrumDM-1.1-20111020
...
{\color{dblue}
\url{http://www.ivoa.net/Documents/REC/DM/SpectrumDM-20110318.pdf}
...
Foundation's\footnote{\url{http://www.nsf.gov/}} Information Technology Research
...
(PPARC\footnote{\url{http://www.pparc.ac.uk}}) 
and from the European Commission's
Sixth Framework Program\footnote{\url{http://fp6.cordis.lu/fp6/home.cfm}}
via the Optical Infrared Coordination Network (OPTICON\footnote{\url{http://www.astro-opticon.org}}).
...
This version fixes some issues coming from implementation feedback.
Most fixes are minor and do not represent any fundamental changes with respect to the previous
Recommendation. Modifications to UCDs (Table 1) can have an impact on implementations and/or validators.
...
\begin{verbatim}
2011 Oct 20 V1.1 Mod 8 - Section 1 (Motivation): added scope of v1.1 changes.
  Section 1.2 (Architecture): dropped references to SpectrumDM1.2.
  References update. (As suggested by Christophe Arviset).

2011 Oct 17  V1.1 Mod 7 - UCD updates suggested by S. Derriere.

2011 Mar 19  V1.1 Mod 6  - Architecture section

2011 Mar 3   V1.1 (1.04) Mod 5 - Typo corrections
...
2007 Oct 29 V1.03: SpectrumDM 1.03 released as a Recommendation
...
\colorbox{iblue}{
\psfig{file=diagrams/sd.eps,width=6.0in}
}
...
\colorbox{iblue}{
\psfig{file=diagrams/specumln3.eps,width=6.0in}
}
...
\colorbox{iblue}{
\psfig{file=diagrams/ndataf1.eps,width=6.0in}
}
{
\colorbox{iblue}{
\begin{minipage}{6.0in}
...
\colorbox{iblue}{
\psfig{file=diagrams/ncharf2.eps,width=6.0in}
}
{
\colorbox{iblue}{
\begin{minipage}{6.0in}
...
\colorbox{iblue}{
\psfig{file=diagrams/specstc.eps,width=6.0in}
}
{
\colorbox{iblue}{
\begin{minipage}{6.0in}
...
\colorbox{iblue}{
\psfig{file=diagrams/specu3f.eps,width=6.0in}
}
{
\colorbox{iblue}{
\begin{minipage}{6.0in}
